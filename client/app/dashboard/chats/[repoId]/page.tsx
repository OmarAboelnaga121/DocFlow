    ...
    <div className="min-h-screen flex flex-col bg-[#0b1326] text-[#dae2fd]">
      ...
      <main className="flex-1 pt-28 pb-20 px-6 md:px-8 max-w-5xl mx-auto w-full">
        ...
        <div className="mb-6 flex items-center justify-between">
          <Link
            href="/dashboard"
            className="inline-flex items-center gap-2 text-xs font-medium text-[#94a3b8] hover:text-[#4edea3] transition-colors group"
          >
        ...
        <div className="text-center mb-10">
          <div className="inline-flex items-center justify-center gap-2 px-3 py-1 rounded-full bg-[#10b981]/10 border border-[#10b981]/25 text-[#4edea3] text-xs font-mono mb-3">
          ...
          {repo && (
            <div className="flex items-center justify-center gap-3 mt-3 flex-wrap text-xs text-[#94a3b8]">
              ...
              <span className="text-white/20">•</span>
              <span className="px-2 py-0.5 rounded bg-white/[0.06] border border-white/[0.08] text-[11px] font-mono text-[#bbcabf]">
                Status: {repo.status}
              </span>
            </div>
          )}
        ...
        <div className="bg-[#131b2e]/90 backdrop-blur-xl border border-white/[0.08] rounded-2xl p-6 md:p-8 shadow-2xl mb-14 transition-all">
          ...
          <form onSubmit={(e) => handleCreateChat(e)} className="flex flex-col gap-3">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-3">
              ...
              <div className="md:col-span-9 bg-[#0b1326] border border-white/[0.1] focus-within:border-[#4edea3]/70 focus-within:ring-1 focus-within:ring-[#4edea3]/30 rounded-xl p-1.5 pl-4 flex items-center gap-3 transition-all">
              ...
              <div className="md:col-span-3">
                <button
                  ...
                  className="w-full bg-[#10b981] hover:bg-[#4edea3] text-[#060e20] font-semibold text-sm h-full min-h-[44px] px-6 py-2.5 rounded-xl transition-all shadow-sm hover:shadow-[0_0_20px_rgba(78,222,163,0.35)] disabled:opacity-40 disabled:cursor-not-allowed flex items-center justify-center gap-2 cursor-pointer"
                >
                  {isCreatingChat ? (
                    <>
            ...
            <div className="mt-2 flex items-center gap-2 flex-wrap">
              <span className="text-[11px] font-mono text-[#64748b]">Suggested topics:</span>
              {quickPrompts.map((prompt, idx) => (
                <button
                  ...
                  className="text-[11px] text-[#94a3b8] hover:text-[#4edea3] bg-white/[0.04] hover:bg-white/[0.08] border border-white/[0.08] px-2.5 py-1 rounded-lg transition-all cursor-pointer"
                >
                  {prompt}
                </button>
              ))}
        ...
        <section>
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-xl font-bold text-[#f8fafc] tracking-tight flex items-center gap-2">
              ...
              {chats.length > 0 && (
                <span className="text-xs px-2 py-0.5 rounded-full bg-white/[0.08] text-[#94a3b8] font-mono font-normal">
                  {chats.length}
                </span>
              )}
            </h2>
                ...
                >
                  <div>
                    <div className="flex items-start justify-between gap-2 mb-2">
                      ...
                      <span className="material-symbols-outlined text-[#64748b] group-hover:text-[#4edea3] text-lg transition-colors shrink-0">
                        chat_bubble_outline
                      </span>
                    </div>
                  ...
                  <div className="pt-3 border-t border-white/[0.06] flex items-center justify-between text-xs text-[#64748b]">
                    <span className="font-mono text-[11px]">
                      {new Date(chat.updatedAt || chat.createdAt).toLocaleDateString()}
                    </span>
                    <span className="text-[#4edea3] font-medium text-xs flex items-center gap-1 group-hover:translate-x-0.5 transition-transform">
                      Open Chat
