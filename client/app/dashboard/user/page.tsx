      ...
      <main className="flex-1 max-w-5xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        ...
        <div className="flex items-center justify-between gap-4 mb-8">
          ...
          <div className="flex items-center gap-2">
            <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-mono bg-surface-container-low border border-surface-container text-text-secondary">
        ...
        {isLoading ? (
          <div className="space-y-6 animate-pulse">
            <div className="h-44 rounded-xl bg-surface-container border border-surface-container" />
            <div className="h-10 w-80 rounded-lg bg-surface-container border border-surface-container" />
            <div className="h-96 rounded-xl bg-surface-container border border-surface-container" />
          </div>
        ) : user ? (
          <div className="space-y-8">
            ...
            <div className="relative rounded-2xl bg-white border border-surface-container p-6 md:p-8 overflow-hidden shadow-sm">
              ...
              <div className="relative flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div className="flex items-start md:items-center gap-5">
                  ...
                  <div className="relative group">
                    <div className="w-20 h-20 md:w-24 md:h-24 rounded-2xl bg-surface-container-low border-2 border-surface-container overflow-hidden flex items-center justify-center shadow-xs">
                      {avatarPreview ? (
                        <Image
                          src={avatarPreview}
                ...
                {/* Quick Action / Status */}
                <div className="flex md:flex-col items-end justify-between md:justify-center gap-2 pt-4 md:pt-0 border-t md:border-t-0 border-surface-container">
            ...
            {/* Navigation Tabs */}
            <div className="flex items-center gap-2 border-b border-border-hairline pb-px overflow-x-auto">
              <button
                type="button"
            ...
            {activeTab === "general" && (
              <form onSubmit={handleSaveProfile} className="space-y-6">
                <div className="rounded-2xl bg-white border border-surface-container p-6 md:p-8 space-y-8 shadow-sm">
                  {/* Section Title */}
                  ...
                  <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
                    <div className="relative">
                      <div className="w-20 h-20 rounded-2xl bg-surface-container-low border-2 border-surface-container overflow-hidden flex items-center justify-center shadow-inner">
                        {avatarPreview ? (
                          <Image
                            src={avatarPreview}
                            alt="Avatar Preview"
                      ...
                      {avatarFile && (
                        <span className="absolute -top-1 -right-1 w-4 h-4 bg-primary rounded-full border-2 border-surface-container-low flex items-center justify-center text-[9px] text-white font-bold">
                          ✓
                        </span>
                      )}
                    </div>
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-3">
                        ...
                        <button
                          ...
                          className="px-3.5 py-1.5 rounded-lg bg-surface-container hover:bg-surface-container-high border border-surface-container text-xs font-medium text-text-primary transition-colors cursor-pointer flex items-center gap-1.5"
                        >
                        ...
                        {avatarFile && (
                          <button
                            ...
                            className="px-3 py-1.5 rounded-lg bg-transparent hover:bg-surface-container text-xs text-text-secondary hover:text-on-surface transition-colors cursor-pointer"
                          >
                            Revert
                          </button>
                        )}
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        <input
                          ...
                          className="w-full bg-surface-container-low border border-surface-container rounded-xl px-4 py-2.5 text-sm text-text-primary placeholder-text-secondary/60 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary/40 transition-all font-sans"
                        />
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative flex items-center">
                        ...
                        <input
                          ...
                          className="w-full bg-surface-container-low border border-surface-container rounded-xl pl-8 pr-4 py-2.5 text-sm text-text-primary placeholder-text-secondary/60 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary/40 transition-all font-mono"
                        />
                      </div>
                      <p className="text-[11px] text-text-secondary">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        <input
                          ...
                          value={user.email}
                          disabled
                          className="w-full bg-surface-container-low/50 border border-surface-container rounded-xl px-4 py-2.5 text-sm text-text-secondary cursor-not-allowed font-mono opacity-80"
                        />
                        <span className="material-symbols-outlined absolute right-3 top-2.5 text-text-secondary/60 text-[18px] pointer-events-none">
                          lock
                        </span>
                      ...
                      <div className="flex items-center gap-2">
                        <div className="relative flex-1">
                          <input
                            ...
                            value={user.id}
                            disabled
                            className="w-full bg-surface-container-low/50 border border-surface-container rounded-xl px-4 py-2.5 text-xs text-text-secondary cursor-not-allowed font-mono truncate opacity-80"
                          />
                        </div>
                        <button
                          type="button"
                          ...
                          title="Copy User ID"
                          className="px-3 py-2.5 rounded-xl bg-surface-container hover:bg-surface-container-high border border-surface-container text-text-primary transition-colors cursor-pointer flex items-center justify-center shrink-0"
                        >
                ...
                <div className="flex items-center justify-between pt-2">
                  ...
                  <div className="flex items-center gap-3">
                    <button
                      ...
                      className="px-4 py-2.5 rounded-xl border border-surface-container text-xs font-medium text-text-secondary hover:text-on-surface hover:bg-surface-container-low transition-all disabled:opacity-40 disabled:pointer-events-none cursor-pointer"
                    >
                      Discard
                    </button>
                    ...
                    <button
                      type="submit"
                      disabled={!hasChanges || isSavingProfile}
                      className="px-5 py-2.5 rounded-xl bg-primary-container hover:bg-primary text-white text-xs font-semibold font-mono tracking-wide transition-all shadow-md disabled:opacity-40 disabled:pointer-events-none cursor-pointer flex items-center gap-2"
                    >
                      {isSavingProfile ? (
                        <>
            ...
            {activeTab === "role" && (
              <form onSubmit={handleSaveRole} className="space-y-6">
                <div className="rounded-2xl bg-white border border-surface-container p-6 md:p-8 space-y-6 shadow-sm">
                  {/* Section Title */}
                  <div className="border-b border-surface-container pb-4 flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                    <div>
                      <h2 className="text-lg font-semibold text-text-primary">Workspace Role & Mode</h2>
                      <p className="text-xs text-text-secondary mt-1">
                        Tailors documentation depth, AST analysis capabilities, and AI assistant prompt context.
                      </p>
                    </div>
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-lg bg-surface-container-low border border-surface-container text-xs font-mono text-text-secondary">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                    ...
                    <div
                      ...
                      className={`relative cursor-pointer rounded-xl p-5 transition-all duration-200 flex flex-col justify-between border ${selectedRole === "DEVELOPER"
                          ...
                          : "bg-surface-container-low/40 border-surface-container hover:border-surface-container-high hover:bg-surface-container-low"
                        }`}
                    >
                      <div>
                        ...
                        <div className="space-y-1 mb-3">
                          <div className="flex items-center gap-2">
                            <h3 className="text-base font-bold text-text-primary">Developer</h3>
                      ...
                      <div className="flex flex-wrap gap-1.5 pt-3 border-t border-surface-container">
                        <span className="px-2 py-0.5 rounded bg-surface-container-low border border-surface-container text-[10px] font-mono text-on-background">
                          Git Repos
                        </span>
                        <span className="px-2 py-0.5 rounded bg-surface-container-low border border-surface-container text-[10px] font-mono text-on-background">
                          AST Parsers
                    ...
                    >
                      <div>
                        ...
                        <div className="space-y-1 mb-3">
                          <div className="flex items-center gap-2">
                            <h3 className="text-base font-bold text-text-primary">Product / Business</h3>
                    ...
                    <div
                      ...
                      className={`relative cursor-pointer rounded-xl p-5 transition-all duration-200 flex flex-col justify-between border ${selectedRole === "USER"
                          ? "bg-white border-[#a78bfa] shadow-md ring-1 ring-[#a78bfa]"
                          : "bg-surface-container-low/40 border-surface-container hover:border-surface-container-high hover:bg-surface-container-low"
                        }`}
                    >
                      <div>
                        ...
                        <div className="space-y-1 mb-3">
                          <div className="flex items-center gap-2">
                            <h3 className="text-base font-bold text-text-primary">General User</h3>
