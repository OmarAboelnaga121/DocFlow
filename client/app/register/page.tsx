    ...
    <div className="min-h-screen w-full grid grid-cols-1 lg:grid-cols-2 bg-[#0b1326] text-[#dae2fd]">
      ...
      <div className="relative flex flex-col justify-between p-8 sm:p-12 lg:p-16 border-b lg:border-b-0 lg:border-r border-white/[0.08] bg-[#060e20]/60 overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col">
          ...
          <div className="mt-2 sm:mt-4 max-w-lg">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-[#f8fafc] tracking-tight leading-[1.15] mb-4">
              Stop writing docs.
              <br />
              <span className="text-[#4edea3]">Start building.</span>
            </h1>
      ...
      <div className="relative flex items-center justify-center p-6 sm:p-12 lg:p-16 bg-[#0b1326]">
        ...
        <div className="relative z-10 w-full max-w-[440px] mx-auto flex flex-col py-6">
          ...
          {error && (
            <div
              className="p-3 mb-5 rounded-md flex items-center gap-2.5 text-xs text-[#ffb4ab] border border-[#ffb4ab]/30"
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div className="flex items-center gap-4 p-3 rounded-lg bg-[#131b2e]/60 border border-white/[0.08]">
              <input
                type="file"
                ref={fileInputRef}
              ...
              <div
                ...
                className="relative w-14 h-14 rounded-full bg-[#1e293b] border-2 border-dashed border-white/20 hover:border-[#4edea3] flex items-center justify-center cursor-pointer transition-all overflow-hidden shrink-0 group"
                title="Upload avatar"
              >
                {avatarPreview ? (
                  ...
                  <span className="material-symbols-outlined text-xl text-[#94a3b8] group-hover:text-[#4edea3] transition-colors">
                    add_a_photo
                  </span>
                )}
              </div>
              ...
              <div className="flex flex-col flex-1 min-w-0">
                <div className="flex items-center justify-between">
                  <span className="font-mono text-xs font-medium text-[#dae2fd] uppercase tracking-wider">
                    Avatar
                  </span>
                  {avatarFile && (
                    <button
                ...
                <p className="text-xs text-[#94a3b8]/80 truncate mt-0.5">
                  {avatarFile ? avatarFile.name : "JPEG, PNG, or WEBP (Max 5MB)"}
                </p>
                <button
                  type="button"
                  onClick={() => fileInputRef.current?.click()}
                  className="text-left text-xs font-semibold text-[#4edea3] hover:underline mt-0.5"
                >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <div className="flex flex-col gap-1.5">
                <label
                  ...
                  className="font-mono text-xs font-medium text-[#dae2fd] uppercase tracking-wider"
                >
                  Username <span className="text-[#4edea3]">*</span>
                </label>
                <input
                  id="username"
                  type="text"
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  required
                  minLength={6}
                  className="w-full h-11 pl-3.5 pr-10 rounded-md bg-[#131b2e] border border-white/[0.12] text-[#dae2fd] placeholder:text-[#94a3b8]/50 text-sm focus:outline-none focus:border-[#4edea3] focus:ring-1 focus:ring-[#4edea3] transition-colors"
                />
                <button
                  type="button"
                  onClick={() => setShowPassword(!showPassword)}
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-[#94a3b8] hover:text-[#dae2fd] focus:outline-none transition-colors"
                  tabIndex={-1}
            ...
            <button
              ...
              disabled={isLoading}
              className="mt-2 w-full h-11 rounded-md font-semibold text-sm transition-all duration-200 cursor-pointer flex items-center justify-center gap-2 disabled:opacity-60 disabled:cursor-not-allowed shadow-md shadow-[#10b981]/10"
              style={{
                background: "#10b981",
                color: "#060e20",
              }}
          ...
          <div className="mt-4 text-center">
            <p className="text-[11px] text-[#94a3b8]/70 leading-relaxed">
              ...
              <Link
                href="#"
                className="text-[#94a3b8] hover:text-[#dae2fd] underline underline-offset-2"
              >
                Terms of Service
              </Link>{" "}
              and{" "}
